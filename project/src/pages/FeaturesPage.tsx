...
const features = [
	{
		...
		description:
			'Monitor your shipments and inventory in real-time with live updates and notifications.',
		icon: (
			<svg
	...
	},
	{
		...
		description:
			'Enterprise-grade security for your operations and sensitive data.',
		icon: (
			<svg
		...
		<div className="max-w-3xl w-full bg-white rounded-xl shadow-lg p-8 border border-slate-200">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
				{features.map((feature, i) => (
					<div
						key={i}
						className="flex items-start gap-4 bg-slate-50 rounded-lg p-5 border border-slate-100 shadow-sm"
					>
